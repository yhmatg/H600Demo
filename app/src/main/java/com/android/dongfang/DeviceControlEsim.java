...
public class DeviceControlEsim {
    ...
    public DeviceControlEsim() throws IOException {
    }

    public DeviceControlEsim(String path) throws IOException {
     ...
     * @throws IOException
     */
    public DeviceControlEsim(PowerType powerType, int... gpios) throws IOException {
        this.gpios = gpios;
        this.power_type = powerType;
    }

    public DeviceControlEsim(String powerType, String... gpios) throws IOException {
        this.gtGpios = gpios;
        switch (powerType) {
            case "GAOTONG_MAIN":
     ...
     * @throws IOException
     */
    public DeviceControlEsim(String powerType, int... gpios) throws IOException {
        this.gpios = gpios;
        switch (powerType) {
            case "MAIN":
    ...
    public void MainPowerOn(int gpio) throws IOException {
        DeviceControlEsim deviceControl = new DeviceControlEsim(DeviceControlEsim.POWER_MAIN);
    ...
    public void ExpandPowerOn(int gpio) throws IOException {
        DeviceControlEsim deviceControl = new DeviceControlEsim(DeviceControlEsim.POWER_EXTERNAL);
        deviceControl.setGpio(gpio);
        deviceControl.writeON();
        deviceControl.DeviceClose();
    }
    ...
    public void Expand2PowerOn(int gpio) throws IOException {
        DeviceControlEsim deviceControl = new DeviceControlEsim(DeviceControlEsim.POWER_EXTERNAL2);
        deviceControl.setGpio(gpio);
        deviceControl.writeON();
        deviceControl.DeviceClose();
    }
    ...
    public void newSetGpioOn(int gpio) throws IOException {
        DeviceControlEsim deviceControl = new DeviceControlEsim(POWER_NEWMAIN);
        //将GPIO设置为高电平
